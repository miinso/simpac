...
int main(void)
{
    ...
    const char text[] = "자동보호를 외웠습니다.\n철갑마안장의 남은시간 입니다:\n1일 14시간 20분 7초\n말에서 내렸습니다.\n북문에 이르렀으니...\n스피드: 바람의나라에서 가장 거지가 많은곳 !!";
    ...
    Font font = LoadFont("resources/generic.fnt");
    ...
    while (!WindowShouldClose())        // Detect window close button or ESC key
    {
        ...
        BeginDrawing();
            ...
            DrawTextBoxed(font, text, (Rectangle){ container.x + 4, container.y + 4, container.width - 4, container.height - 4 }, font.baseSize*2, .0f, wordWrap, GRAY);
