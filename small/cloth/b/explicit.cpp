// Mass-Spring Simulator (explicit euler, buffer-direct)
...
// explicit euler: position uses OLD velocity, then velocity updates
...
int main() {
    ...
    auto integrator = ecs.system("Explicit Euler")
        .kind(sim::Simulate)
        .run([&](flecs::iter&) {
