...
struct trimesh {
    ...
    int num_edges() const { return edge_ids.size() / 2; }
    int num_tris() const { return tri_ids.size() / 3; }
};
...
flecs::entity create_body_from_mesh(
    flecs::world& world, const Mesh& mesh, const Eigen::Vector3f& position);

flecs::entity create_plane_body(
    flecs::world& world,
    float width,
    float length,
...
flecs::entity create_body_from_3d_file(
    flecs::world& world,
    const char* filename,
    const Eigen::Vector3f& position,
...
flecs::entity create_sphere_body(
    flecs::world& world,
    float radius,
    const Eigen::Vector3f& position,
    const Eigen::Quaternionf& orientation = Eigen::Quaternionf::Identity());

flecs::entity create_poly_body(
    flecs::world& world,
    int sides,
    float radius,
    const Eigen::Vector3f& position,
...
flecs::entity create_triangle_body(
    flecs::world& world,
    float size,
    const Eigen::Vector3f& position,
    const Eigen::Quaternionf& orientation = Eigen::Quaternionf::Identity());
