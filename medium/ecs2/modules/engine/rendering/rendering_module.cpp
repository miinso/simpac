...
namespace rendering {
    void RenderingModule::register_components(flecs::world &world) {
    ...
    void RenderingModule::register_systems(flecs::world &world) {
        ...
        world.system<const particle_q, const particle_qd, const particle_radius *>("Draw particle")
                .kind<rendering::Render>()
                .each(systems::draw_particle);

        // world.system<particle_q, particle_qd, particle_f>()
        //         .kind(flecs::OnUpdate)
        //         .each(systems::integrate_particle_position);

        // world.system<const core::Position, const Renderable, const
        // core::GameSettings,
        ...
        //         .with<Priority>()
        //         .order_by<Priority>([](flecs::entity_t e1, const Priority
        //         *p1, flecs::entity_t e2,
        //                                const Priority *p2) {
        ...
        // world.system<const Renderable, const core::Position,
        // const Rotation *>(
        ...
        // world.system<ProgressBar, const core::Position,
        // const Renderable>("Draw health bar")
        //         .kind<Render>()
