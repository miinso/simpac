...
struct Contact {
    ...
    void compute_jacobian() {
        ...
        if (!e1.has<IsPinned>()) {
            const auto& pos1 = e1.get<Position>();
            const auto& mass1 = e1.get<Mass>();
            const auto& inertia1 = e1.get<WorldInverseInertia>();
        ...
        if (!e2.has<IsPinned>()) {
            const auto& pos2 = e2.get<Position>();
            const auto& mass2 = e2.get<Mass>();
            const auto& inertia2 = e2.get<WorldInverseInertia>();
