...
namespace physics {
    ...
    public:
        ...
        static flecs::system m_collision_detection_baseline;
        static flecs::system m_collision_detection_with_hash_grid;
        static flecs::system m_collision_detection_with_hash_grid_alt;
