...
void main() {
    ...
    fragPosition = vec3(instanceTransform * vec4(vertexPosition, 1.0f));

    fragTexCoord = vertexTexCoord * 2.0f;
    ...
    gl_Position = mvp * instanceTransform * vec4(vertexPosition, 1.0f);
}